...
Forging policy scripts are much like :term:`validator scripts<validator script>`, and they are written similarly, so check out the `validator script tutorial <basic_validators.rst>`_ before reading this one .
