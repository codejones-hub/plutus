...
import           Prelude                              hiding (drop, filter, foldl, foldr, lookup, map, null, splitAt,
                                                       take)

import           Data.Map.Internal                    (AreWeStrict (..), Map (..), SimpleWhenMatched, SimpleWhenMissing,
                                                       WhenMatched (..), WhenMissing (..), assocs, atKeyImpl,
                                                       atKeyPlain, balance, balanceL, balanceR, delete, deleteAt,
                                                       deleteFindMax, deleteFindMin, deleteMax, deleteMin, difference,
                                                       disjoint, drop, dropMissing, dropWhileAntitone, elemAt, elems,
                                                       empty, filter, filterAMissing, filterMissing, filterWithKey,
                                                       findIndex, findMax, findMin, foldMapWithKey, foldl, foldl',
                                                       foldlWithKey, foldlWithKey', foldr, foldr', foldrWithKey,
                                                       foldrWithKey', glue, insertMax, intersection, isProperSubmapOf,
                                                       isProperSubmapOfBy, isSubmapOf, isSubmapOfBy, keys, keysSet,
                                                       link, link2, lookup, lookupGE, lookupGT, lookupIndex, lookupLE,
                                                       lookupLT, lookupMax, lookupMin, mapKeys, mapKeysMonotonic,
                                                       maxView, maxViewWithKey, member, merge, mergeA, minView,
                                                       minViewWithKey, notMember, null, partition, partitionWithKey,
                                                       preserveMissing, preserveMissing', restrictKeys, runWhenMatched,
                                                       runWhenMissing, size, spanAntitone, split, splitAt, splitLookup,
                                                       splitRoot, take, takeWhileAntitone, toAscList, toDescList,
                                                       toList, union, unions, withoutKeys, (!), (!?), (\\))
