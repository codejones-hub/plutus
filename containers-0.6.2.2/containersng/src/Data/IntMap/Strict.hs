...
import qualified Data.IntMap.Merge.Strict             as Merge (mapMaybeMissing, mapMissing, merge, traverseMissing,
                                                                zipWithMaybeMatched)
#if defined(__GLASGOW_HASKELL__)
...
import           Prelude                              hiding (filter, foldl, foldr, lookup, map, max, min, null)
