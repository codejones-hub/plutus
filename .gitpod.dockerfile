...
COPY marlowe-dashboard-server/marlowe-dashboard-server.cabal marlowe-dashboard-server/marlowe-dashboard-server.cabal
...
COPY plutus-errors/plutus-errors.cabal plutus-errors/plutus-errors.cabal
COPY plutus-ledger-api/plutus-ledger-api.cabal plutus-ledger-api/plutus-ledger-api.cabal
...
COPY plutus-pab/plutus-pab.cabal plutus-pab/plutus-pab.cabal
...
RUN . /home/gitpod/.nix-profile/etc/profile.d/nix.sh \
  && nix-env -f nix/gitpod-shell.nix -iAnixpkgsInputs

RUN . /home/gitpod/.nix-profile/etc/profile.d/nix.sh \
  && nix-env -f nix/gitpod-shell.nix -iAlocalInputs

RUN . /home/gitpod/.nix-profile/etc/profile.d/nix.sh \
  && nix-env -f nix/gitpod-shell.nix -iAagdaWithStdlib

RUN . /home/gitpod/.nix-profile/etc/profile.d/nix.sh \
  && nix-env -f nix/gitpod-shell.nix -iAsphinxTools

RUN . /home/gitpod/.nix-profile/etc/profile.d/nix.sh \
  && nix-env -f nix/gitpod-shell.nix -iAghc
