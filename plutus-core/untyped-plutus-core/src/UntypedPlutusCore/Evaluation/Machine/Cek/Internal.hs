...
{-
For no reason that I can discern, exporting this specialized version of runCek causes the rewrite rule generated by
the above SPECIALIZE pragma to actually work, otherwise it does not.
-}
runCekSpec
    :: BuiltinsRuntime DefaultFun (CekValue DefaultUni DefaultFun)
    -> ExBudgetMode cost DefaultUni DefaultFun
