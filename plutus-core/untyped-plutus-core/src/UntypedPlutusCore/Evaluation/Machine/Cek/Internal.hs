...
throwingDischarged
    :: (PrettyUni uni fun)
    => AReview (EvaluationError CekUserError (MachineError fun (Term DeBruijn uni fun ()))) t -> t -> CekValue uni fun -> CekM cost uni fun s x
...
lookupVarName :: forall uni fun cost s . (PrettyUni uni fun) => DeBruijn -> CekValEnv uni fun -> CekM cost uni fun s (CekValue uni fun)
...
enterComputeCek
    ...
    -> CekValEnv uni fun
    -> TermWithMem uni fun
    -> CekM cost uni fun s (Term DeBruijn uni fun ())
enterComputeCek = computeCek where
    ...
    -}
    returnCek :: Context uni fun -> CekValue uni fun -> CekM cost uni fun s (Term DeBruijn uni fun ())
    ...
    forceEvaluate
        :: Context uni fun -> CekValue uni fun -> CekM cost uni fun s (Term DeBruijn uni fun ())
