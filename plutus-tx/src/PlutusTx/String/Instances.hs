...
module PlutusTx.String.Instances (stringToBuiltinString) where

import           PlutusTx.String.Internal as Plutus
...
instance Haskell.IsString Plutus.String where
...
stringToBuiltinString :: Haskell.String -> Plutus.String
